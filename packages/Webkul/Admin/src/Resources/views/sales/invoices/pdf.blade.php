...
<head>
    ...
    <style type="text/css">
        @if ( ! empty($fontPath['regular'])) @font-face {
        ...
        @endif @if ( ! empty($fontPath['bold'])) @font-face {
...
<body dir="{{ core()->getCurrentLocale()->direction }}">
    <div class="logo-container {{ core()->getCurrentLocale()->direction }}">
        <img src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAwIiBoZWlnaHQ9IjUwIiB2aWV3Qm94PSIwIDAgMTAwIDUwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPg0KICAgIDx0ZXh0IHg9IjEwIiB5PSIzMCIgZm9udC1zaXplPSIyNCIgZm9udC1mYW1pbHk9IkFyaWFsIiBmaWxsPSJibGFjayI+RkFDVFVSQTwvdGV4dD4NCjwvc3ZnPg==" width="150" height="50" alt="Logo de Factura">
            ...
            <table class="{{ core()->getCurrentLocale()->direction }}">
                ...
                <tbody>
                    <tr>
                        @if ($invoice->order->billing_address)
                        <td style="width: 50%">
                            <div>{{ $invoice->order->billing_address->company_name ?? '' }}
                                <div>
                        ...
                        @if ($invoice->order->shipping_address)
                        <td style="width: 50%">
                            <div>{{ $invoice->order->shipping_address->company_name ?? '' }}
                                <div>
