...
return [
    ...
    [
        ...
        'fields' => [
            ...
            [
                'name'          => 'client_secret', // 🔹 Se agrega client_secret (Access Token)
            ...
            [
                'name'          => 'accepted_currencies', // 🔹 Se cambia a select con valores predefinidos
            ...
            [
                'name'          => 'sandbox', // 🔹 Se agrega sandbox para pruebas
    ...
    [
        ...
        'name'   => 'admin::app.configuration.index.sales.payment-methods.mercadopago-standard',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.mercadopago-standard-info',
        'sort'   => 5,
        'fields' => [
            [
                'name'          => 'title',
